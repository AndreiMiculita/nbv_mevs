...
parser.add_argument("--out", help="Select a desired output directory.", default="./depth-dataset-train")
...
def nonblocking_custom_capture(tr_mesh, rot_xyz, last_rot):
    ...
    vis.capture_depth_image(get_dataset_path(), depth_scale=10000)

    vis.destroy_window()


def get_dataset_path():
    return "{}/{}/{}_{}_theta_{}_phi_{}_vc_{}.png".format(OUT_DIR,
                                                          ViewData.obj_label,
                                                          ViewData.obj_label,
                                                          ViewData.obj_index,
                                                          int(ViewData.theta),
